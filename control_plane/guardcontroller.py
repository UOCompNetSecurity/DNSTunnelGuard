...
class GuardController: 
    ...
    def process_record(self, event: RecordEvent): 
        ...
        qnames = [parseutils.parse_qname(str(question.qname)) for question in event.record.questions]
    ...
    def _get_blockable_domains(self, qname: str) -> list[str]: 
        ...
        return [domain for domain in sub_domains if self.tld_list is None or not domain in self.tld_list]
